...
class Song(object):
    ...
    def from_response(cls, song, connection):
        return cls(song['SongID'], song['Name'] if 'Name' in song else song['SongName'], song['ArtistID'], song['ArtistName'], song['AlbumID'], song['AlbumName'],
                   ALBUM_COVER_URL + song['CoverArtFilename'] if song['CoverArtFilename'] else None, song['TrackNum'] if 'TrackNum' in song else None, song['EstimateDuration'], song['Popularity'] if 'Popularity' in song else None, connection)
